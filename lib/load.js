 ...
 */
function load(directories, context)
{
  var files
    , layers
    , cacheKey
  ...
  // consider it `context`
  if (typeOf(directories) == 'function' || typeOf(directories) == 'object')
  {
    context   = directories;
  ...
  context.directories = directories || context.directories || context.defaults.directories;
